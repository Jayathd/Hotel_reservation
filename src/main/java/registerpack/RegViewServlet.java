...
public class RegViewServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.print("}");
		out.print("h1 {");
		out.print("  color: white;");  // Text color changed to white
		...
		out.print("<table>");
		out.print("<tr><th>Id</th><th>First Name</th><th>Last Name</th><th>NIC</th><th>Email</th><th>Password</th><th>Repassword</th><th>Phone</th><th>DOB</th><th>Country</th><th>Edit</th><th>Delete</th></tr>");
		for (Reg e : list) {
			out.print("<tr><td>" + e.getId() + "</td><td>" + e.getFristname() + "</td><td>" + e.getLastname()
					...
					+ "' class='edit'>Edit</a></td><td><a href='RegDeleteServlet?id=" + e.getId()
